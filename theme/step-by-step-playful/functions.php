...
function step_by_step_assets(): void
{
    wp_enqueue_style(
        'step-by-step-fonts',
        'https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,650;9..144,700&family=Manrope:wght@400;550;650;750;820&display=swap',
        [],
        null
    );

    wp_enqueue_style('step-by-step-style', get_stylesheet_uri(), ['step-by-step-fonts'], '1.2.4');
    wp_enqueue_script('step-by-step-menu', get_template_directory_uri() . '/assets/js/menu.js', [], '1.2.4', true);
}
